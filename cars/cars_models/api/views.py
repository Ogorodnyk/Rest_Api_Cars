...
from cars_models.models import Car, GiveRate
from cars_models.api.serializers import CarSerializer, CarPopularSerializer, CarRateSerializer
...
class CarRateCreateAPIView(APIView):

    # def get(self, request, format=None):
    #     car = GiveRate.objects.all()
    #     serializer = CarRateSerializer(car, many=True)
    #     return Response(serializer.data)
